            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" class="mr-1" enctype="multipart/form-data">
                        ...
                        <div class="form-group mt-3">
                            <input type="number" autocomplete="off" class="form-control" name="old_price" placeholder="Ancien Prix" id="">
                        </div>
                        <div class="form-group mt-3">
                            <input type="number" autocomplete="off" class="form-control" name="product_quantity" placeholder="Quantité" id="">
                        </div>
                        <div class="form-group mt-3">
